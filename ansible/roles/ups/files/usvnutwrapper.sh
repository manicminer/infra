...
# Script: 	usvnutwrapper.sh
# Author:	Martin (Machtl) Lang
# E-Mail:	usvnutwrapper@machtl.com
...
#	The script is simple and small and solves some problems having apcupsd and nut-server on the 
...
#
#	2.) Copy this script into /usr/local/bin/ and make it executable. You can simply run this command to copy
# 		the script to the right location:
#		wget https://machtl.com/linux/nutwrapper/usvnutwrapper.sh -O /usr/local/bin/usvnutwrapper.sh
...
#		tcpserver -q -c 10 -HR 0.0.0.0 3493 /usr/local/bin/usvnutwrapper.sh &
#
...
setdefaultvalues() {
UPS_MFR="USV NUT Apcupsd Wrapper"	
UPS_UPSNAME="NO NAME"
UPS_MODEL="NO MODEL"
UPS_BCHARGE="0"
UPS_TIMELEFT="0"
